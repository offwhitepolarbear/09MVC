	...
	<tr>
		...
		<td background="/images/ct_ttl_img02.gif" width="100%" style="padding-left: 10px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="93%" class="ct_ttl01">상품재입고</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<td class="ct_write01">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="105" class="productNo" name="prodNo">${product.prodNo}</td>
						</tr>
					</table>
				</td>
			</tr>
			...
			<tr>
				<td width="104" class="ct_write">현재재고</td>
				<td bgcolor="D6D6D6" width="1"></td>
		...
		<td width="104" class="ct_write">
			입고갯수 <img src="/images/ct_icon_red.gif" width="3" height="3" align="absmiddle"/>
		</td>
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
